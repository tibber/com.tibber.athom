...
class MyDevice extends Homey.Device {
	...
	onInit() {
        ...
        this._powerChangedTrigger = new Homey.FlowCardTriggerDevice('watty_power_changed');
        this._powerChangedTrigger.register();

        this._consumptionChangedTrigger = new Homey.FlowCardTriggerDevice('watty_consumption_changed');
        this._consumptionChangedTrigger.register();

        this._costChangedTrigger = new Homey.FlowCardTriggerDevice('watty_cost_changed');
        this._costChangedTrigger.register();

        this._dailyConsumptionReportTrigger = new Homey.FlowCardTriggerDevice('watty_daily_consumption_report');
        this._dailyConsumptionReportTrigger.register();

        this.log(`Tibber Watty device ${this.getName()} has been initialized (throttle: ${this._throttle})`);

...
class WattyDevice extends Device {
    ...
    async onInit() {
        ...
        this.#powerChangedTrigger = this.homey.flow.getDeviceTriggerCard('watty_power_changed');
        //this.#powerChangedTrigger.register();

        this.#consumptionChangedTrigger = this.homey.flow.getDeviceTriggerCard('watty_consumption_changed');
        //this.#consumptionChangedTrigger.register();

        this.#costChangedTrigger = this.homey.flow.getDeviceTriggerCard('watty_cost_changed');
        ...
        this.#dailyConsumptionReportTrigger = this.homey.flow.getDeviceTriggerCard('watty_daily_consumption_report');
        //this.#dailyConsumptionReportTrigger.register();

        this.log(`Tibber Watty device ${this.getName()} has been initialized (throttle: ${this.#throttle})`);
